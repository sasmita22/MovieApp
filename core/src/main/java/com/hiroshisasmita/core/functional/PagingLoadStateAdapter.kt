...
import com.hiroshisasmita.core.databinding.AdapterLoadStateBinding
...
class PagingLoadStateAdapter(
    ...
    inner class LoadStateViewHolder(private val binding: AdapterLoadStateBinding): RecyclerView.ViewHolder(binding.root) {
        fun bindView() {
